...
const allTemplates = {
  ...
  'vite-template-redux': `npx -y tiged@latest --mode=git ${gitHubUrl?.remoteUrl}/packages/vite-template-redux#${gitHubUrl?.currentBranch} example -v && cd example && npm install`,
}
