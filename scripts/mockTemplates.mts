...
const allTemplates = {
  ...
  'vite-template-redux': `npx ./node_modules/tiged/dist/bin.mjs --mode=git ${gitHubUrl?.remoteUrl}/packages/vite-template-redux#${gitHubUrl?.currentBranch} example -v && cd example && npm install`,
