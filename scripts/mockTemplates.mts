...
const allTemplates = {
  ...
  'vite-template-redux': `npx -y tiged@git://github.com/aryaemami59/tiged.git#workflow --mode=git ${gitHubUrl?.remoteUrl}/packages/vite-template-redux#${gitHubUrl?.currentBranch} example -v && cd example && npm install`,
