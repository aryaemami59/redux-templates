...
const allTemplates = {
  ...
  'vite-template-redux': `rm -rf ~/.degit && yarn tiged --disable-cache ${'https://github.com/aryaemami59/redux-templates'}/packages/vite-template-redux#${'convert-to-monorepo'} example -v && cd example && npm install`,
}
