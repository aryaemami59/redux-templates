...
const allTemplates = {
  ...
  'vite-template-redux': `rm -rf ~/.degit && npx tiged --disable-cache ${gitHubUrl.remoteUrl}/packages/vite-template-redux#${gitHubUrl.currentBranch} example -v && cd example && npm install`,
}
