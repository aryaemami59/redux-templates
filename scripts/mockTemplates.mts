...
const allTemplates = {
  ...
  'vite-template-redux': `npx tiged@aryaemami59/tiged#migrate-to-typescript --mode=git ${gitHubUrl?.remoteUrl}/packages/vite-template-redux#${gitHubUrl?.currentBranch} example -v && cd example && npm install && npm run build`,
