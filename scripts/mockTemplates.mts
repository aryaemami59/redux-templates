...
const allTemplates = {
  ...
  'vite-template-redux': `rm -rf ~/.degit && rm -rf ~/.tiged && npx -y tiged@latest --disable-cache --mode=git ${gitHubUrl.remoteUrl}/packages/vite-template-redux#${gitHubUrl.currentBranch} example -v && cd example && npm install`,
}
