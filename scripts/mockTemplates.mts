...
const allTemplates = {
  ...
  'vite-template-redux': `npx tiged@aryaemami59/tiged#workflow --mode=git ${gitHubUrl?.remoteUrl}/packages/vite-template-redux#${gitHubUrl?.currentBranch} example -v && cd example && npm install`,
