...
const allTemplates = {
  ...
  'vite-template-redux': `rm -rf ~/.degit && npx -y tiged@https://github.com/aryaemami59/tiged#migrate-to-typescript --disable-cache ${gitHubUrl.remoteUrl}/packages/vite-template-redux#${gitHubUrl.currentBranch} example -v && cd example && npm install`,
}
