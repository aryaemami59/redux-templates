...
const allTemplates = {
  ...
  'vite-template-redux': `rm -rf ~/.degit && node ./node_modules/tiged/dist/bin.mjs --disable-cache ${gitHubUrl.remoteUrl}/packages/vite-template-redux#${gitHubUrl.currentBranch} example -v && cd example && npm install`,
}
