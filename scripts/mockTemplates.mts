...
const allTemplates = {
  ...
  'vite-template-redux': `rm -rf ~/.degit && yarn dlx tiged@aryaemami59/tiged#migrate-to-typescript --disable-cache ${gitHubUrl.remoteUrl}/packages/vite-template-redux#${gitHubUrl.currentBranch} example -v && cd example && npm install`,
}
